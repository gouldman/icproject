...
vlog -quiet -sv -work ${LIB_PATH} ${RTL_PATH}/components/sp_ram_ip.sv                  || goto error
vlog -quiet -sv -work ${LIB_PATH} ${RTL_PATH}/components/four_sram_wrapper.sv       || goto error
vlog -quiet -sv -work ${LIB_PATH} +define+functional  ${RTL_PATH}/components/SPHDL100909.v              || goto error
...
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${CORE_DEFINES} ${RTL_PATH}/top_top.sv            || goto error
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${CORE_DEFINES} ${RTL_PATH}/PADS_Jun2013.v        || goto error
