...
#  Generated on:      Thu Apr 10 12:58:33 2025
#  Design:            top_top
#  Command:           saveDesign design/after_iofiller
###############################################################
current_design top_top
set_clock_gating_check -rise -setup 0 
set_clock_gating_check -fall -setup 0 
create_clock [get_ports {in_tck_i}]  -name in_tck_i -period 100.000000 -waveform {0.000000 50.000000}
set_propagated_clock  [get_clocks {in_tck_i}]
create_clock  -name clk_jtag -period 100.000000 -waveform {0.000000 50.000000}
set_clock_transition  -rise -max 0.2 [get_clocks {clk_jtag}]
set_clock_transition  -fall -max 0.2 [get_clocks {clk_jtag}]
create_clock [get_ports {in_spi_clk_i}]  -name in_spi_clk_i -period 100.000000 -waveform {0.000000 50.000000}
set_propagated_clock  [get_clocks {in_spi_clk_i}]
create_clock [get_ports {in_clk}]  -name in_clk -period 40.000000 -waveform {0.000000 20.000000}
set_propagated_clock  [get_clocks {in_clk}]
set_clock_transition  -rise -max 0.2 [get_clocks {in_clk}]
set_clock_transition  -fall -max 0.2 [get_clocks {in_clk}]
create_clock  -name clk_spi -period 100.000000 -waveform {0.000000 50.000000}
set_clock_transition  -rise -max 0.2 [get_clocks {clk_spi}]
set_clock_transition  -fall -max 0.2 [get_clocks {clk_spi}]
set_propagated_clock  [get_ports {in_tck_i}]
set_propagated_clock  [get_ports {in_spi_clk_i}]
set_propagated_clock  [get_ports {in_clk}]
set_wire_load_mode enclosed
set_max_fanout 20  [get_designs {top_top}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_tms_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_tck_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_trstn_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_fetch_enable_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_uart_rx}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_sdi3_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_testmode_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_uart_dsr}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_rst_n}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_clk_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_clk}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_sdi1_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_tdi_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_uart_cts}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_sdi2_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_cs_i}]
set_input_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {in_spi_sdi0_i}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_sdo0_o}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {gpio_out8}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_mode_o[1]}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_uart_dtr}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_uart_tx}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_uart_rts}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_sdo3_o}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_tdo_o}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_sdo1_o}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_mode_o[0]}]
set_output_delay -add_delay 0.5 -clock [get_clocks {clk_jtag}] [get_ports {out_spi_sdo2_o}]
set_clock_uncertainty 0.5 [get_clocks {clk_jtag}]
set_clock_uncertainty 0.5 [get_clocks {clk_spi}]
set_clock_uncertainty  0.5 [get_ports {in_clk}]
...
set_clock_groups -name __default_2 -asynchronous  -group  [get_clocks {in_clk}] -group  [get_clocks {clk_spi}] -group  [get_clocks {clk_jtag}]
